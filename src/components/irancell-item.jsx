...
class IrancellItem extends React.Component {
    ...
    showChecked(checked,name){
        if (name==="notAmazing"){
            ...
            localStorage.setItem('isAmazing', this.state.isAmazing);
        ...
        return (
            <div className="py-3" >
                <div className="row justify-content-center">
                    ...
                    <div className="checkbox-item border border-success bg-light ">
                        <input className="mr-2" type="checkbox" id="1"
                               checked={this.state.isNotAmazing}
                               name={"notAmazing"}
                               onClick={((e) => this.showChecked(e.target.checked,e.target.name))}
                        />
                        <label htmlFor="1">شارژ مستقیم</label>
                    </div>
                    <div className="checkbox-item  border border-success bg-light ">
                        <input className="mr-2" type="checkbox" id="2"
                               checked={this.state.isAmazing}
                               name={"Amazing"}
                               onClick={((e) => this.showChecked(e.target.checked,e.target.name))}

                        />
                        <label  htmlFor="2">شگفت انگیز</label>
                    </div>
                ...
                <div className="row justify-content-center py-2">
                    <div className="checkbox-item  border  bg-light ">
